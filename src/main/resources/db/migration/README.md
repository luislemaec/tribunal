...
- `V1__baseline_inicial.sql` es solo para bases nuevas e incluye la estructura final, indices y el tipo documental tecnico de certificados.
- La secuencia consolidada para una base limpia en desarrollo es: V1 estructura completa y V2 datos iniciales definitivos.
