...
- `V2__datos_iniciales.sql` carga catalogos, personas, iglesias, usuarios BCrypt, proceso, cronograma, recintos, mesas, plantillas, menus y relaciones iniciales autorizadas para una base nueva.
