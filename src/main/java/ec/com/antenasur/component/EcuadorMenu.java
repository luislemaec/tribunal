 ...
 */
package ec.com.antenasur.component;
...
@ListenerFor(sourceClass = EcuadorMenu.class, systemEventClass = PostAddToViewEvent.class)
public class EcuadorMenu extends AbstractMenu implements Widget, ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "ec.com.antenasur.component.EcuadorMenu";
    public static final String COMPONENT_FAMILY = "ec.com.antenasur.component";
    private static final String DEFAULT_RENDERER = "ec.com.antenasur.component.ecuadorMenuRenderer";
